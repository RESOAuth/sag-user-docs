---
sidebar_label: "Upstreams"
sidebar_position: 3
description: "Route sign-in by email domain to upstream providers, optional local identities, or email codes."
---
...
[local identities](../self-host/local-identities.md). Routing is by email domain, so there
