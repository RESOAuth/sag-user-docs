...
sidebar_position: 10
description: "Verify signed SAG source and container releases before deploying them."
---
...
See [ADR 0022](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0022-signed-development-images.md).
...
[ADR 0020](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0020-signed-releases.md) will authenticate final ZIP bytes and
