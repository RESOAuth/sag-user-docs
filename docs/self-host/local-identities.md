---
sidebar_label: "Local identities"
sidebar_position: 6
description: "Provision and operate local password and MFA identities on a single Node instance."
---
...
[ADR 0023](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0023-node-flat-file-local-identities.md), with plaintext TOTP
storage defined by [ADR 0025](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0025-plaintext-local-totp-seeds.md).
...
[Configuration](../reference/configuration.md#local-identities).
...
[Operations](operations.md#rotating-the-master-secret).
