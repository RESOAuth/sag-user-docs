---
sidebar_label: "State and limits"
sidebar_position: 5
description: "SAG keeps no database. A session is an encrypted cookie, an in-flight request is an encrypted form field, an authorisation code is an encrypted string..."
---

# The one piece of state, and the limits it buys

SAG's core keeps no database. A session is an encrypted cookie, an in-flight request
...
several. See
[ADR 0001](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0001-stateless-with-optional-state-store.md) for why the store
is optional at all, and [ADR 0002](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0002-email-otp-code-design.md) for why
...
[ADR 0001](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0001-stateless-with-optional-state-store.md) for why.
...
see [ADR 0007](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0007-require-prefix-for-fail-fast-flags.md).
...
[Local identities](local-identities.md) for the complete boundary.
...
minutes" - see [ADR 0002](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0002-email-otp-code-design.md). Set
...
[ADR 0003](https://github.com/RESOAuth/smart-access-gateway/blob/main/docs/adr/0003-silent-enumeration-and-rate-limit-defence.md) for why.
...
[test/local-stack/verify.js](https://github.com/RESOAuth/smart-access-gateway/blob/main/test/local-stack/verify.js) does exactly that
