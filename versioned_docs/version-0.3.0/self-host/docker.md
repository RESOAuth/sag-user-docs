...
| `./data/local-identities/` | Optional operator-provisioned credential records. See [Local identities](local-identities.md) |
...
container, following [Local identities](local-identities.md). Do not scale
...
provenance verify. Follow [Release verification](release-verification.md),
