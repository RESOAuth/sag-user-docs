---
sidebar_label: "Profile claims"
sidebar_position: 4
description: "SAG asserts one thing it can prove: an email address. Everything else on the profile scope either came from an upstream provider or was guessed, and the..."
---
...
[Local identities](../self-host/local-identities.md#what-a-relying-party-sees).
