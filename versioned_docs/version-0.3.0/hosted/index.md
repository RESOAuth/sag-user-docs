...
- **No password to store.** The hosted gateway never handles one, so neither do you.
...
The free shared service has [terms of service](./terms-of-service.md). The
[privacy notice](./privacy-notice.md) explains what happens to sign-in and
...
| Read the free service terms | [Terms of service](./terms-of-service.md) |
| See how information is handled | [Privacy notice](./privacy-notice.md) |
