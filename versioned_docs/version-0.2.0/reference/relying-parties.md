---
sidebar_label: "Relying parties"
sidebar_position: 2
description: "A relying party is an application that sends people to SAG to sign in. There are four ways to describe one, checked in this order."
---
...
[test/local-stack/](../self-host/local-stack.md), which is also the shortest
